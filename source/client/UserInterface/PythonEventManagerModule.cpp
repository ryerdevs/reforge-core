...
PyObject * eventRegisterEventSet(PyObject * poSelf, PyObject * poArgs)
{
	...
	const int iEventIndex = CPythonEventManager::Instance().RegisterEventSet(szFileName);
...
PyObject * eventRegisterEventSetFromString(PyObject * poSelf, PyObject * poArgs)
{
	...
	const int iEventIndex = CPythonEventManager::Instance().RegisterEventSetFromString(szEventString);
	return Py_BuildValue("i", iEventIndex);
}
...
PyObject * eventGetLineCount(PyObject * poSelf, PyObject * poArgs)
{
	...
	const int iLineCount = CPythonEventManager::Instance().GetLineCount(iIndex);
