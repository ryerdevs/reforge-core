...
private:
	...
	void				FillRect(RECT& fillRect, DWORD fillColor) const;
	inline void			GDIFillRect(RECT& fillRect, DWORD fillColor) const;
	inline void			GDIBlt(IDirectDrawSurface *pSrcSurface, RECT *pDestRect) const;
