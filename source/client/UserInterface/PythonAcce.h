...
public:
	...
	DWORD	GetPrice() const {return dwPrice;}
	bool	GetAttachedItem(BYTE bPos, BYTE & bHere, WORD & wCell) const;
	void	GetResultItem(DWORD & dwItemVnum, DWORD & dwMinAbs, DWORD & dwMaxAbs) const;
