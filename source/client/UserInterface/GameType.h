...
struct SAffects
{
	...
	BOOL IsAffect(BYTE byIndex) const
	{
...
constexpr DWORD c_Costume_Slot_Start	= c_Equipment_Start + CItemData::WEAR_COSTUME_BODY;
...
constexpr DWORD	c_Costume_Slot_Mount	= c_Costume_Slot_Start + CItemData::COSTUME_MOUNT;
#endif
#ifdef ENABLE_ACCE_COSTUME_SYSTEM
constexpr DWORD	c_Costume_Slot_Acce		= c_Costume_Slot_Start + CItemData::COSTUME_ACCE;
#endif

#if defined(ENABLE_WEAPON_COSTUME_SYSTEM) || defined(ENABLE_ACCE_COSTUME_SYSTEM)
constexpr DWORD c_Costume_Slot_Count	= 4;
#elif defined(ENABLE_MOUNT_COSTUME_SYSTEM)
constexpr DWORD c_Costume_Slot_Count	= 3;
#else
constexpr DWORD c_Costume_Slot_Count	= 2;
#endif

constexpr DWORD c_Costume_Slot_End		= c_Costume_Slot_Start + c_Costume_Slot_Count;

#ifdef ENABLE_WEAPON_COSTUME_SYSTEM
constexpr DWORD	c_Costume_Slot_Weapon	= c_Equipment_Start + CItemData::WEAR_COSTUME_WEAPON; // c_Costume_Slot_End + 1;
#endif

#endif

constexpr DWORD c_Wear_Max = CItemData::WEAR_MAX_NUM;
constexpr DWORD c_DragonSoul_Equip_Start = c_ItemSlot_Count + c_Wear_Max;
constexpr DWORD c_DragonSoul_Equip_Slot_Max = 6;
constexpr DWORD c_DragonSoul_Equip_End = c_DragonSoul_Equip_Start + c_DragonSoul_Equip_Slot_Max * DS_DECK_MAX_NUM;

constexpr DWORD c_DragonSoul_Equip_Reserved_Count = c_DragonSoul_Equip_Slot_Max * 3;

#ifdef ENABLE_NEW_EQUIPMENT_SYSTEM
constexpr DWORD c_Belt_Inventory_Slot_Start = c_DragonSoul_Equip_End + c_DragonSoul_Equip_Reserved_Count;
constexpr DWORD c_Belt_Inventory_Width = 4;
constexpr DWORD c_Belt_Inventory_Height= 4;
constexpr DWORD c_Belt_Inventory_Slot_Count = c_Belt_Inventory_Width * c_Belt_Inventory_Height;
constexpr DWORD c_Belt_Inventory_Slot_End = c_Belt_Inventory_Slot_Start + c_Belt_Inventory_Slot_Count;

constexpr DWORD c_Inventory_Count	= c_Belt_Inventory_Slot_End;
#else
constexpr DWORD c_Inventory_Count	= c_DragonSoul_Equip_End;
#endif

constexpr DWORD c_DragonSoul_Inventory_Start = 0;
constexpr DWORD c_DragonSoul_Inventory_Box_Size = 32;
constexpr DWORD c_DragonSoul_Inventory_Count = CItemData::DS_SLOT_NUM_TYPES * DRAGON_SOUL_GRADE_MAX * c_DragonSoul_Inventory_Box_Size;
constexpr DWORD c_DragonSoul_Inventory_End = c_DragonSoul_Inventory_Start + c_DragonSoul_Inventory_Count;
...
constexpr DWORD c_QuickBar_Slot_Count = 12;
...
{
	const float dx = static_cast<float>(ix1 - ix2);
	const float dy = static_cast<float>(iy1 - iy2);
