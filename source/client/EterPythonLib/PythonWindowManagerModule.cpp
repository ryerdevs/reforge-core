...
PyObject * wndMgrGetWndGlobalPosition(PyObject * poSelf, PyObject * poArgs)
{
	...
	const RECT & rRect = pWindow->GetRect();
...
{
	char retBuf[1024];
	const int retLen = CGraphicTextInstance::Hyperlink_GetText(retBuf, sizeof(retBuf)-1);
	retBuf[retLen] = '\0';
...
PyObject * wndMgrIsPickedWindow(PyObject * poSelf, PyObject * poArgs)
{
	...
	const UI::CWindow * pPickedWin = UI::CWindowManager::Instance().GetPointWindow();
...
PyObject * wndMgrArrangeSlot(PyObject * poSelf, PyObject * poArgs)
{
	...
	const auto pGridSlotWin = (UI::CGridSlotWindow *)pWin;
...
PyObject * wndMgrSetCoverButton(PyObject * poSelf, PyObject * poArgs)
{
	...
	const auto pSlotWin = (UI::CSlotWindow *)pWindow;
...
PyObject * wndTextGetTextSize(PyObject * poSelf, PyObject * poArgs)
{
	...
	const auto pkTextLine=(UI::CTextLine*)pWindow;
...
PyObject * wndMgrGetSlotCoolTime(PyObject * poSelf, PyObject * poArgs)
{
	...
	float fElapsedTime = 0.0f;
	const float fCoolTime = pSlotWin->GetSlotCoolTime(iSlotIndex, &fElapsedTime);
