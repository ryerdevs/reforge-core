...
const D3DXVECTOR3&	CActorInstance::GetMovementVectorRef() const
{
	if (m_pkHorse)
...
const TPixelPosition& CActorInstance::NEW_GetAtkPixelPositionRef() const
{
	return m_kPPosAtk;
}

const TPixelPosition& CActorInstance::NEW_GetSrcPixelPositionRef() const
{
	return m_kPPosSrc;
}

const TPixelPosition& CActorInstance::NEW_GetDstPixelPositionRef() const
{
	return m_kPPosDst;
}
...
void CActorInstance::GetPixelPosition(TPixelPosition * pPixelPosition) const
{
