...
bool CFlyTarget::IsObject() const
{
	return (TYPE_OBJECT==GetType());
}

bool CFlyTarget::IsPosition() const
{
	return (TYPE_POSITION==GetType());
}

bool CFlyTarget::IsValidTarget() const
{
...
CFlyTarget::EType CFlyTarget::GetType() const
{
	return m_eType;
}

IFlyTargetableObject* CFlyTarget::GetFlyTarget() const
{
...
void CFlyTarget::GetFlyTargetData(CFlyTarget * pFlyTarget) const
{
