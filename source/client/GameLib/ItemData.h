...
#pragma pack(pop)
	...
	public:
		...
		CGraphicThing * GetModelThing() const;
		CGraphicThing * GetSubModelThing() const;
		CGraphicThing * GetDropModelThing() const;
		CGraphicSubImage * GetIconImage();

		DWORD GetLODModelThingCount() const;
		BOOL GetLODModelThingPointer(DWORD dwIndex, CGraphicThing ** ppModelThing) const;

		DWORD GetAttachingDataCount() const;
		BOOL GetCollisionDataPointer(DWORD dwIndex, const NRaceData::TAttachingData ** c_ppAttachingData) const;
		BOOL GetAttachingDataPointer(DWORD dwIndex, const NRaceData::TAttachingData ** c_ppAttachingData) const;
		...
		UINT GetRealRefine() const;
		bool IsArrow() const;
		bool IsHairDye() const;
		bool IsSkillBook() const;
		bool IsClam() const;
		bool IsCorDraconis() const;
		bool IsMarriage() const;
		bool IsParty() const;
		bool IsCraft() const;
		bool IsScroll() const;
		UINT GetLevelLimit() const;
	...
	public:
		float GetItemParticleScale(BYTE bJob, BYTE bSex) const;
