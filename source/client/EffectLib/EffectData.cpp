...
DWORD CEffectData::GetLightCount() const
{
	return m_LightVector.size();
}

CLightData * CEffectData::GetLightPointer(DWORD dwPosition) const
{
	assert(dwPosition < m_LightVector.size());
	return m_LightVector[dwPosition];
}

DWORD CEffectData::GetParticleCount() const
{
	return m_ParticleVector.size();
}
CParticleSystemData * CEffectData::GetParticlePointer(DWORD dwPosition) const
{
...
DWORD CEffectData::GetMeshCount() const
{
	return m_MeshVector.size();
}
CEffectMeshScript * CEffectData::GetMeshPointer(DWORD dwPosition) const
{
