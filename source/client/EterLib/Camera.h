...
constexpr float CAMERA_TARGET_FACE = 150.0f;
...
//	protected:
	...
	public:
		...
		//////////////////////////////////////////////////////////////////////////
		void Update();
		eCameraState GetCameraState() const {return m_eCameraState;}
		...
		const float & GetPitchBackUp() const { return m_fPitchBackup; }
		const float & GetRollBackUp() const { return m_fRollBackup; }
		const float & GetDistanceBackUp() const { return m_fDistanceBackup; }
	...
	public:
		...
		bool isTerrainCollisionEnable() const { return m_bProcessTerrainCollision; }
