...
class CHorseRider
{
	public:
		...
		int		GetHorseST() const { return c_aHorseStat[GetHorseLevel()].iST; }
		int		GetHorseDX() const { return c_aHorseStat[GetHorseLevel()].iDX; }
		int		GetHorseHT() const { return c_aHorseStat[GetHorseLevel()].iHT; }
		int		GetHorseIQ() const { return c_aHorseStat[GetHorseLevel()].iIQ; }
		int		GetHorseArmor() const { return c_aHorseStat[GetHorseLevel()].iArmor; }
