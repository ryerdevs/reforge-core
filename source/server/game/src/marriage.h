...
namespace marriage
{
	...
	struct TMarriage
	{
		...
		void WarpToWeddingMap(DWORD dwPID) const;
		void Save();
		void SetMarried();
	...
	class CManager : public singleton<CManager>
	{
		public:
			...
			bool	IsMarriageUniqueItem(DWORD dwItemVnum) const;

			bool	IsMarried(DWORD dwPlayerID);
			bool	IsEngaged(DWORD dwPlayerID);
			bool	IsEngagedOrMarried(DWORD dwPlayerID);

			void	RequestAdd(DWORD dwPID1, DWORD dwPID2, const char* szName1, const char* szName2) const;
			void	Add(DWORD dwPID1, DWORD dwPID2, time_t tMarryTime, const char* szName1, const char* szName2);

			void	RequestUpdate(DWORD dwPID1, DWORD dwPID2, int iUpdatePoint, BYTE byMarried) const;
			void	Update(DWORD dwPID1, DWORD dwPID2, long lTotalPoint, BYTE byMarried);

			void	RequestRemove(DWORD dwPID1, DWORD dwPID2) const;
			...
			void	RequestEndWedding(DWORD dwPID1, DWORD dwPID2) const;
