...
class ItemToolTip(ToolTip):
			...
			if 27989 == itemVnum or 76006 == itemVnum:
				...
				if 0 != metinSlot:
					...
					if xPos != 0 and yPos != 0:
						...
						if app.ENABLE_ATLAS_MARK_ON_WARP_SCROLLS:
	...
	if app.ENABLE_ATLAS_MARK_ON_WARP_SCROLLS:
		def AppendMapImage(self, mapName, pos, base):
			if not pack.Exist("d:/ymir work/ui/atlas/{}/atlas.sub".format(mapName)):
				return
			xPos, yPos = pos
			xBase, yBase = base
			...
			mapImage.LoadImage("d:/ymir work/ui/atlas/{}/atlas.sub".format(mapName))
			# set image scale
			imageScale = 1.0
