...
class CPolymorphUtils : public singleton<CPolymorphUtils>
{
	...
	public :
		...
		bool UpdateBookPracticeGrade(LPCHARACTER pChar, LPITEM pItem) const;
		bool GiveBook(LPCHARACTER pChar, DWORD dwMobVnum, DWORD dwPracticeCount, BYTE BookLevel, BYTE LevelLimit) const;
		bool BookUpgrade(LPCHARACTER pChar, LPITEM pItem) const;
};
