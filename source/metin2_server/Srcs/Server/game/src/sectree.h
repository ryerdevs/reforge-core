...
class SECTREE
{
	...
	public:
		...
		CAttribute *			GetAttributePtr() const { return m_pkAttribute; }

		DWORD				GetAttribute(long x, long y) const;
		...
		void				SetAttribute(DWORD x, DWORD y, DWORD dwAttr) const;
		void				RemoveAttribute(DWORD x, DWORD y, DWORD dwAttr) const;
