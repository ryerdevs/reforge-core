...
namespace quest
{
	...
	class CQuestManager : public singleton<CQuestManager>
	{
		...
		public:
			...
			QuestState *	GetCurrentState() const { return m_CurrentRunningState; }
			...
			bool		CanEndQuestAtState(const string& quest_name, const string& state_name) const;
			...
			int			GetQuestStateIndex(const string& quest_name, const string& state_name) const;
			const char*		GetQuestStateName(const string& quest_name, const int state_index) const;
			...
			void		RequestSetEventFlag(const string& name, int value) const;

			void		SetEventFlag(const string& name, int value);
			int			GetEventFlag(const string& name);
			void		BroadcastEventFlagOnLogin(LPCHARACTER ch) const;
		...
		public:
			...
			bool		IsInOtherPCBlock() const;
			PC*			GetOtherPCBlockRootPC() const;
		private:
