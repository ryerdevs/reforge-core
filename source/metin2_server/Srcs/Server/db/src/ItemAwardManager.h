...
class ItemAwardManager : public singleton<ItemAwardManager>
{
	...
	#ifdef ENABLE_EXTEND_ITEM_AWARD
	void 				CheckItemAddonType(TItemAward & pkItemAward, const TItemTable & pkItemTable) const;
	void				CheckItemCount(TItemAward & pkItemAward, const TItemTable & pkItemTable) const;
	void				CheckItemSocket(TItemAward & pkItemAward, const TItemTable & pkItemTable) const;
	void				CheckItemBlend(TItemAward & pkItemAward, const TItemTable & pkItemTable) const;
	void				CheckItemSkillBook(TItemAward & pkItemAward, const std::vector<TSkillTable> vec_skillTable) const;
	#endif
