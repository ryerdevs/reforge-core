...
|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
\*******************************************************************/
void ItemAwardManager::CheckItemAddonType(TItemAward & rkItemAward, const TItemTable & rkItemTable) const
{
...
|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
\*******************************************************************/
void ItemAwardManager::CheckItemSkillBook(TItemAward & rkItemAward, const std::vector<TSkillTable> vec_skillTable) const
{
...
|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
\*******************************************************************/
void ItemAwardManager::CheckItemCount(TItemAward & rkItemAward, const TItemTable & rkItemTable) const
{
...
|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
\*******************************************************************/
void ItemAwardManager::CheckItemSocket(TItemAward & rkItemAward, const TItemTable & rkItemTable) const
{
	// check for limited time items
	for (const auto & limit : rkItemTable.aLimits)
	{
		if (LIMIT_REAL_TIME == limit.bType || LIMIT_REAL_TIME_START_FIRST_USE == limit.bType || LIMIT_TIMER_BASED_ON_WEAR == limit.bType)
			return;
	}
	...
	if (rkItemAward.dwSocket0 == 0 && maxSockets >= 1)
		rkItemAward.dwSocket0 = 1;
	if (rkItemAward.dwSocket1 == 0 && maxSockets >= 2)
		rkItemAward.dwSocket1 = 1;
	if (rkItemAward.dwSocket2 == 0 && maxSockets >= 3)
...
|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
\*******************************************************************/
void ItemAwardManager::CheckItemBlend(TItemAward & rkItemAward, const TItemTable & rkItemTable) const
{
