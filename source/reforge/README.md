...
| `realm/` | realm | Lógica de juego por regiones (F4+): funciones puras (combate, ai, packets) + **bevy_ecs World** (adoptado 2026-08-12, ADR-0010 §2 — user decision: mob-farming density) + estado por conexión + `WorldStore` — 64 tests |
