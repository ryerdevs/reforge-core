...
{
	static constexpr int GUILD_LEVEL_MAX = 20;
...
{
	static constexpr unsigned SKILL_POWER_NUM = 50;
...
struct SLOCALEDATA
{
	...
	{ nullptr,			nullptr,			0,		"testtesttesttest"	}
};
...
bool LocaleService_LoadGlobal(HINSTANCE hInstance)
{
	...
	if (gs_iLocale < 0)
		return false;
	if(nFoundLocales > 1)
		::DialogBox(hInstance, MAKEINTRESOURCE(IDD_SELECT_LOCALE), nullptr, (DLGPROC) SelectDlgProc);
	if (gs_iLocale < 0)
		return false;
