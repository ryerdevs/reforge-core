...
PyObject* grpCreateTextBar(PyObject* poSelf, PyObject* poArgs)
{
	...
	const auto pTextBar = new CTextBar(12, false);
...
PyObject* grpCreateBigTextBar(PyObject* poSelf, PyObject* poArgs)
{
	...
	const auto pTextBar = new CTextBar(iFontSize, true);
	if (!pTextBar->Create(nullptr, iWidth, iHeight))
	{
		delete pTextBar;
		return Py_BuildValue("i", nullptr);
...
PyObject* grpDestroyTextBar(PyObject* poSelf, PyObject* poArgs)
{
	...
	const auto pTextBar = (CTextBar *)iHandle;
	delete pTextBar;
...
{
	const int iValue = CPythonGraphic::Instance().GetAvailableMemory();
...
PyObject * grpSaveScreenShotToPath(PyObject * poSelf, PyObject * poArgs)
{
	...
	const BOOL bResult = CPythonGraphic::Instance().SaveScreenShot(szPath);
