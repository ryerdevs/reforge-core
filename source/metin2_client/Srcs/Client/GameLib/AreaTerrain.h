...
class CTerrain : public CTerrainImpl, public CGraphicBase
{
	public:
		...
		WORD			WE_GetHeightMapValue(short sX, short sY) const;
		...
		BYTE 			GetAttr(WORD wCoordX, WORD wCoordY) const;
		bool			isAttrOn(WORD wCoordX, WORD wCoordY, BYTE byAttrFlag) const;

		//////////////////////////////////////////////////////////////////////////
		// Water
		BYTE *			GetWaterMap()	{ return m_abyWaterMap; }
		void			GetWaterHeight(BYTE byWaterNum, long * plWaterHeight) const;
		bool			GetWaterHeight(WORD wCoordX, WORD wCoordY, long * plWaterHeight) const;
		...
		inline LPDIRECT3DTEXTURE9	GetMiniMapTexture() const { return m_lpMiniMapTexture; }
	...
	protected:
		...
		void PutImage32(BYTE * pbySrc, BYTE * pbyDst, long src_pitch, long dst_pitch, long lTextureWidth, long lTextureHeight, bool bResize = false) const;
		void PutImage16(BYTE * pbySrc, BYTE * pbyDst, long src_pitch, long dst_pitch, long lTextureWidth, long lTextureHeight, bool bResize = false) const;
