...
namespace prt
{
	...
	constexpr char c_szPropertyTypeName[PROPERTY_TYPE_MAX_NUM][32] =
	{
		"None",
		"Tree",
		"Building",
	...
	constexpr char c_szPropertyExtension[PROPERTY_TYPE_MAX_NUM][16] =
	{
		".pr",
		".prt",
		".prb",
	...
	constexpr char c_szPlayTypeName[AMBIENCE_PLAY_TYPE_MAX_NUM][8] =
	{
		"ONCE",
		"STEP",
		"LOOP",
...
constexpr int c_Section_xAttributeCellSize = 50;
constexpr int c_Section_yAttributeCellSize = 50;
constexpr int c_Section_xCellSize = 100;
constexpr int c_Section_yCellSize = 100;
