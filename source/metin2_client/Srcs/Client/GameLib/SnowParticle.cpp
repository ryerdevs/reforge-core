...
void CSnowParticle::GetVerticies(SParticleVertex & rv3Vertex1, SParticleVertex & rv3Vertex2,
								 SParticleVertex & rv3Vertex3, SParticleVertex & rv3Vertex4) const
{
...
{
	const float fRot = frandom(0.0f, 36000.0f) / 100.0f;
	const float fDistance = frandom(0.0f, c_fSnowDistance) / 10.0f;
