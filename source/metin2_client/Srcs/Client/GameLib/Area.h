...
class CArea
{
	public:
		...
		typedef struct SAmbienceInstance : public CScreen
		{
			...
			void Render();
			bool Picking();
			float __GetVolumeFromDistance(float fDistance) const;
		} TAmbienceInstance;
		...
		struct FFindIfCRC
		{
			...
			bool operator() (TCRCWithNumber & rCRCWithNumber) const
			{
	...
	public:
		...
		DWORD			GetObjectDataCount() const;
		...
		void			GetCoordinate(WORD * usCoordX, WORD * usCoordY) const;

		//////////////////////////////////////////////////////////////////////////

		DWORD			DEBUG_GetRenderedCRCNum() const;
		TCRCWithNumberVector & DEBUG_GetRenderedCRCWithNumVector();
		DWORD			DEBUG_GetRenderedGrapphicThingInstanceNum() const;

		CMapOutdoor *	GetOwner() const { return m_pOwnerOutdoorMap; }
	...
	protected:
		...
		void			__LoadAttribute(TObjectInstance * pObjectInstance, const char * c_szAttributeFileName) const;
	...
	protected:
		...
		void			__SetObjectInstance_SetTree(TObjectInstance * pObjectInstance, const TObjectData * c_pData, CProperty * pProperty) const;
		void			__SetObjectInstance_SetBuilding(TObjectInstance * pObjectInstance, const TObjectData * c_pData, CProperty * pProperty) const;
		...
		void			__SetObjectInstance_SetDungeonBlock(TObjectInstance * pObjectInstance, const TObjectData * c_pData, CProperty * pProperty) const;
