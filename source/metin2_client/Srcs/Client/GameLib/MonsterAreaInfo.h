...
public:
	...
	void			GetOrigin(long * plOriginX, long * plOriginY) const;

	void			SetSize(long lSizeX, long lSizeY);
	void			GetSize(long * plSizeX, long * plSizeY) const;

	long			GetLeft() const { return m_lLeft; }
	long			GetTop() const { return m_lTop; }
	long			GetRight() const { return m_lRight; }
	long			GetBottom() const { return m_lBottom; }

public:
	void			SetMonsterAreaInfoType(EMonsterAreaInfoType eMonsterAreaInfoType) { m_eMonsterAreaInfoType = eMonsterAreaInfoType; }
	EMonsterAreaInfoType GetMonsterAreaInfoType() const { return m_eMonsterAreaInfoType; }
...
public:
	...
	DWORD			GetMonsterGroupID() const { return m_dwGroupID; }
	std::string		GetMonsterGroupName() { return m_strGroupName; }
	std::string		GetMonsterGroupLeaderName() { return m_strLeaderName; }
	DWORD			GetMonsterGroupFollowerCount() const { return m_dwFollowerCount; }
...
public:
	...
	DWORD			GetMonsterVID() const { return m_dwVID; }
...
public:
	...
	EMonsterDir		GetMonsterDir() const { return m_eMonsterDir; }
	D3DXVECTOR2		GetMonsterDirVector() const { return m_v2Monsterdirection; }
	D3DXVECTOR2		GetTempMonsterPos(DWORD dwIndex) const;
