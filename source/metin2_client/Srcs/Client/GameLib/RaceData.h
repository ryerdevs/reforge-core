...
class CRaceData
{
	...
	public:
		...
		CAttributeData * GetAttributeDataPtr() const;
		...
		BOOL GetBodyCollisionDataPointer(const NRaceData::TAttachingData ** c_ppAttachingData) const;
		...
		DWORD GetSmokeEffectID(UINT eSmoke) const;
