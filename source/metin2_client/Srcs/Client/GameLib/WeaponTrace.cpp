...
void CWeaponTrace::Render()
{
	...
	const LPDIRECT3DTEXTURE9 lpTexture= nullptr;
...
{
	const auto pImage = (CGraphicImage *)CResourceManager::Instance().GetResourcePointer("lot_ade10-2.tga");
...
bool CWeaponTrace::SetWeaponInstance(CGraphicThingInstance * pInstance, DWORD dwModelIndex, const char * c_szBoneName)
{
	...
	const D3DXVECTOR3 v3Bone(pmat->_41,pmat->_42,pmat->_43);

	const auto val1 = (v3Bone-v3Min);
	const auto val2 = (v3Bone-v3Max);
	m_fLength =
		sqrtf(
			fMAX(
